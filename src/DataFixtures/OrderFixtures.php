...
class OrderFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        $ordersData = [
            ...
            [
                'reference' => 'ORD-0003',
                'createdAt' => new \DateTime('2023-09-10'),
            ...
            [
                'reference' => 'ORD-0006',
                'createdAt' => new \DateTime('2023-09-22'),
                'status' => OrderStatus::Shipped,
                'user' => 'user_4',
            ...
            [
                'reference' => 'ORD-0007',
                'createdAt' => new \DateTime('2023-09-25'),
                'status' => OrderStatus::InPreparation,
                'user' => 'user_4',
            ...
            [
                'reference' => 'ORD-0008',
                'createdAt' => new \DateTime('2023-09-28'),
                'status' => OrderStatus::Delivered,
                'user' => 'user_1',
            ...
            [
                'reference' => 'ORD-0009',
                'createdAt' => new \DateTime('2023-09-30'),
                'status' => OrderStatus::Shipped,
                'user' => 'user_2',
            ...
            [
                'reference' => 'ORD-00011',
                'createdAt' => new \DateTime('2023-10-05'),
                'status' => OrderStatus::InPreparation,
                'user' => 'user_4',
    ...
    private createOrder(array $data): Order
    {   
